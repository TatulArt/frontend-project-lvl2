...
test('gendiffPlain', () => {
  ...
  expect(genDiff('__fixtures__/file1.yaml', '__fixtures__/file2.yaml', 'plain')).toEqual(expectedResultPlain);
  expect(genDiff('__fixtures__/file1.yaml', '__fixtures__/file2.json', 'plain')).toEqual(expectedResultPlain);
});
...
test('gendiffJson', () => {
  ...
  expect(genDiff('__fixtures__/file1.yaml', '__fixtures__/file2.yaml', 'json')).toEqual(expectedResultJson);
  expect(genDiff('__fixtures__/file1.yaml', '__fixtures__/file2.json', 'json')).toEqual(expectedResultJson);
});
